...
public class CharacterHurt : MonoBehaviour
{
    ...
    [Header("Settings")] [SerializeField] float respawnTime;
    [SerializeField] private float flashDuration;

    [Header("Events")] [SerializeField] public UnityEvent onHurt = new UnityEvent();

    [Header("Current State")] bool waiting = false;
    bool hurting = false;
    ...
    {
        //I don't want death to happen while the lab is open, or transitioning between states
        if (labStatus.labIsOpen || labStatus.labIsTransitioning)
        {
            return;
        }
